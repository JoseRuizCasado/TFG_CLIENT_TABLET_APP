...
import com.example.nbaanalyzer.api.PointsDistribution
import com.example.nbaanalyzer.api.StarterSubDistribution
...
class TeamPreviewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        getTeamPointDistribution(teamDetailsActivity.selectedTeam)
