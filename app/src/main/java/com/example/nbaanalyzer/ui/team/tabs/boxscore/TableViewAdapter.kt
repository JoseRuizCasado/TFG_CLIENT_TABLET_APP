...
class TableViewAdapter(private val playerStatisticsList: List<Player>, private val listener: (Player) -> Unit): RecyclerView.Adapter<TableViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TableViewAdapter.ViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            setContentBackground(item_boxscore_3pr)
            ...
            item_boxscore_ppg.text = player.ppg.toString()
            item_boxscore_or.text = player.or.toString()
            item_boxscore_dr.text = player.dr.toString()
            item_boxscore_blk.text = player.blk.toString()
            item_boxscore_tov.text = player.tov.toString()
            ...
            item_boxscore_3pr.text = player.threepr.toString()
            ...
            item_boxscore_fta.text = player.fta.toString()
            item_boxscore_ftp.text = player.ftp.toString()
